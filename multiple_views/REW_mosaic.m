function [ mosaic ] = REW_mosaic( im, edge_list, refi, projection_type, ransac_threshold, imfolder, resfolder )
...
%   resfolder: The folder containing the results.
...
if exist([imfolder,'/global_paras.mat'],'file') && ~recomp_global_paras
    ...
    save([resfolder,'/global_paras.mat'],'paras');
end
...
if compute_global_results
    ...
    drawnow;
    if save_results
        imwrite(mosaic, [resfolder, '/mosaic_global.jpg']);
    end
end
...
drawnow;
if save_results
    imwrite(mosaic, [resfolder, '/mosaic_ours.jpg']);
end
